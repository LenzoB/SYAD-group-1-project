    ...
    <body>
        ...
        <div class="deposit_info">
            ...
            <br><br>
                    ...
                    $sql = "SELECT l.date, l.amount, l.interest, m.first_name,
                    m.last_name
                    FROM loan AS l
                    JOIN member AS m ON l.first_name = m.first_name
                    WHERE m.email = ?";
                    ...
                    echo ' <p class="date">'.htmlspecialchars($row['date']) . '</p>
                        <p class="notification">Dear ' .
                                ...
                                ', You have taken out a loan of k' .
                                htmlspecialchars($row['amount']) . ' on DATE:<u>' .
                                htmlspecialchars($row['date']) . '</u>; Interest : <u>'.htmlspecialchars($row['interest']).'</u>  , Please
                                remember that you can repay this loan in
                                installments within a period of one month. Keep in
                                mind that the interest on your loan is also part
                                of your savings, which you will receive after
                                the group closes.</p><br>
                            
                        ';
                        }
                        } else {
                        echo '<p class="notification">No Loans found.</p>';
                        }
