...
p{
    ...
    <body>
        <div class="calculator">
            <button class="cancel"><a href="user_deposit.php"
                    class="times">&times;</a></button>
            <h2>Total Deposits</h2>
                ...
                JOIN member AS m ON d.first_name = m.first_name  WHERE m.email= ?"; 
                ...
                if ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<p>You deposited MWK :<b>$total_deposit</b></p>" ;
